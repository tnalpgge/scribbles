#+title: cowsaypride: like pride flags, but with more early internet
...
To build any individual file, use [[https://ghostscript.com/][Ghostscript]].  e.g. for a PNG image:
...
If [[http://www.graphicsmagick.org][GraphicsMagick]] is available,  license information will be embedded in output images.

The =verify= target embeds checksums in the images and validates them.  It requires [[https://www.perl.org/][Perl]] plus [[https://metacpan.org/dist/Image-PNG-Libpng][Image::PNG::Libpng]] (which requires [[https://libpng.org/pub/png/][libpng]]).
